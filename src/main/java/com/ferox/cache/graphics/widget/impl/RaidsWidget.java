...
public class RaidsWidget extends Widget {
    ...
    private static void party(AdvancedFont[] font) {
        ...
        addHoverButton(22125, 1792, 13, 13, "Kick", -1, 12126, OPTION_OK);
        addHoveredButton(22126, 1793, 13, 13, 12127);
        addHoverButton(22128, 1792, 13, 13, "Kick", -1, 12129, OPTION_OK);
        addHoveredButton(22129, 1793, 13, 13, 12130);
        addHoverButton(22131, 1792, 13, 13, "Kick", -1, 12132, OPTION_OK);
        addHoveredButton(22132, 1793, 13, 13, 12133);
        addHoverButton(22134, 1792, 13, 13, "Kick", -1, 12135, OPTION_OK);
        addHoveredButton(22135, 1793, 13, 13, 12136);
        ...
        setBounds(22125, 198, 241, index++, widget);
        setBounds(22126, 198, 241, index++, widget);
        setBounds(22128, 298, 241, index++, widget);
        setBounds(22129, 298, 241, index++, widget);
        setBounds(22131, 398, 241, index++, widget);
        setBounds(22132, 398, 241, index++, widget);
        setBounds(22134, 299, 275, index++, widget);
        setBounds(22135, 299, 275, index++, widget);
